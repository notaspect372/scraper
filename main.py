...
def get_property_urls(base_url, start_page, end_page):
    ...
    for page in range(start_page, end_page + 1):
        ...
        page_property_urls = ['https://ml.coinafrique.com' + link.get('href') for link in soup.find_all('a', class_='card-image ad__card-image waves-block waves-light')]
...
# Example usage
urls = [
    "https://ml.coinafrique.com/categorie/immobilier?page=18"
]
